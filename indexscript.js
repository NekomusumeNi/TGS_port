...
table1.onclick = function(){
	...
	if (checker1 == 1) {
		arrowdiv.innerHTML = '<img src="https://sivwallin.github.io/TGS_port/indeximages//arrowtop.png">';
		checker1 = 0;
	} else{
		arrowdiv.innerHTML = '<img src="https://sivwallin.github.io/TGS_port/indeximages//headerarrow.png">';
		checker1 = 1;
	}
}
